...
export class WorkflowController {
  ...
  findRun(
    ...
    return this.traceService.getRun(userId, runId);
  }
  ...
  findRuns(
    ...
    return this.traceService.listRuns(userId, id);
  }
  ...
  async run(
    ...
    return this.workflowExecutorService.executeWorkflow(id, runWorkflowDto, undefined, { userId });
  }
  ...
  async streamRun(
    ...
    try {
      await this.workflowExecutorService.executeWorkflow(id, runWorkflowDto, sseSubject, { userId });
      sseSubject.complete();
    } catch (error) {
