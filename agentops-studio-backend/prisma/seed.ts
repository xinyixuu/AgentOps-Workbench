...
async function main() {
  ...
  // 3. 为默认知识库创建一篇文档
  const docContent = `
AgentOps Studio 是一个面向 AI Agent 应用开发的可视化工作流编排与调试平台。它帮助开发者通过直观的拖拽式交互，快速构建、测试和运行复杂的 AI 工作流。
...
- 生产就绪的应用管理：支持草稿、已发布、已归档等多种应用状态。
  `;
  const docName = 'AgentOps Studio 功能介绍.md';
